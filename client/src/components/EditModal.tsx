                  ...
                  <div className="mt-2 sm:mt-0 sm:ml-4">
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="col-span-6">
                        ...
                        <input type="startDate" name="startDate" id="startDate" value={editedLecturer.hours} onChange={handleChange} className="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-blue-50" />
                      </div>
                      <div className="col-span-6">
                      ...
                      <div className="col-span-6">
                        ...
                        <input type="totalAmount" name="totalAmount" id="totalAmount" value={editedLecturer.hours} onChange={handleChange} className="p-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 bg-blue-50" />
                      </div>
                      </div>
